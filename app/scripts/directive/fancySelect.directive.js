angular.module('worker').directive('fancySelect', [
    '$ionicModal',
    function($ionicModal) {
        return {
            ...
            /* Our template */
            replace: true,
            templateUrl: 'views/directive/fancy-select.html',
            ...
            link: function(scope, element, attrs) {
                ...
                if (scope.value) {
                    element.find('input').removeClass('ng-untouched').addClass('ng-touched');
                }
                $ionicModal.fromTemplateUrl(
                    'views/directive/fancy-select-items.html', {
                        'scope': scope
                    }
                ).then(function(modal) {
                    scope.modal = modal;
